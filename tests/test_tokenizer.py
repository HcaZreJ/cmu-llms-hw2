...
def test_not_injective():
    ...
    # Take a look
    print("In injective test:")
    print(f"encoded \"{s1}\":", tokenizer.encode(s1, add_special_tokens=False))
    print(f"encoded \"{s2}\":", tokenizer.encode(s2, add_special_tokens=False))
    print()
...
def test_not_invertible():
    ...
    # Take a look
    print("In invertible test:")
    print(f"encoded \"{s}\":", tokenizer.encode(s, add_special_tokens=False))

    s_recovered = tokenizer.decode(tokenizer.encode(s, add_special_tokens=False))

    # Take a look
    print(f"decode(encode(\"{s}\")):", s_recovered)
    print()
...
def test_not_preserving_concat():
    ...
    # Take a look
    print("In test preserves concat:")
    print(f"Encode(\"{a}{b}\"):", tokenizer.encode(a + b, add_special_tokens=False))
    print(f"Encode(\"{a}\"):", tokenizer.encode(a, add_special_tokens=False))
    print(f"Encode(\"{b}\"):", tokenizer.encode(b, add_special_tokens=False))
